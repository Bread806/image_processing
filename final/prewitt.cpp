...
vector<vector<unsigned char>> Prewitt(const vector<vector<unsigned char>> &grayImg)
{
...
int main()
{
    ...
    vector<vector<unsigned char>> prewittEdgeImg = Prewitt(grayImg);
    cout << "Prewitt done." << endl;

    save_image(outputPrewitt, prewittEdgeImg, width, height);
    cout << "Prewitt edge detection completed. Result saved as " << outputPrewitt << endl;
